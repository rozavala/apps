...
const QB={
  ...
  inventors:[
    ...
    {q:'¿En qué año se fundó el observatorio ALMA?',a:'2013',o:['2013','1990','2005','2020'], tier:'intermediate'},
    {q:'¿En qué año nació el inventor y científico Francisco Varela?',a:'1946',o:['1946','1920','1980','1965'], tier:'advanced'},
    {q:'¿Dónde están ubicados los atrapanieblas pioneros en Chile?',a:'Chungungo',o:['Chungungo','Santiago','Punta Arenas','Valparaíso'], tier:'expert'}
  ],
  volcanes:[
    ...
    {q:'¿Qué ciudad está ubicada a los pies del volcán Villarrica?',a:'Pucón',o:['Pucón','Valparaíso','Iquique','Concepción'], tier:'beginner'},
    {q:'¿Qué lago se encuentra cerca del volcán Osorno?',a:'Lago Llanquihue',o:['Lago Llanquihue','Lago General Carrera','Lago Chungará','Lago Budi'], tier:'advanced'}
  ],
  animales:[
    ...
    {q:'¿Qué animal es el huemul?',a:'Un ciervo',o:['Un ciervo','Un felino','Un ave','Un roedor'], tier:'beginner'},
    {q:'¿Qué animal aparece en el escudo de Chile junto al cóndor?',a:'El huemul',o:['El huemul','El puma','La vicuña','El zorro culpeo'], tier:'intermediate'},
    {q:'¿Qué gran ave vuela sobre la Cordillera de los Andes?',a:'El cóndor',o:['El cóndor','El águila calva','El ñandú','El pingüino'], tier:'beginner'}
  ],
  volcanes_chile:[
