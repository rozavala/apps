(function() {
  ...
  document.addEventListener('keydown', e => {
    if (e.key === 'Escape') {
      ...
      else if (document.getElementById('add-modal').classList.contains('active')) closeModal();
    }
  });
