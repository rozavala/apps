...
- **Zavala Serra Content Guardian Agent**: Aplica la lista de verificación de 5 puntos de neutralidad a todo el contenido nuevo y limita el tamaño de los bancos de preguntas. (Applies the 5-point neutrality checklist to all new content and enforces item limits on question banks.)
