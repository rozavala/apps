...
| **🤖 Code Cadet** | Aprende lógica de programación resolviendo rompecabezas con bloques. (Learn programming logic by solving block-based puzzles.) | [code-cadet.html](code-cadet.html) |
...
- **¡Nueva App "Code Cadet"!**: Aprende lógica de programación resolviendo rompecabezas con bloques. (Learn programming logic by solving block-based puzzles.)
