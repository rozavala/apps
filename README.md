...
| **⚓ Patrón de Lancha** | Prepárate para el examen teórico de Patrón Deportivo de Bahía (DIRECTEMAR). (Prepare for the Patrón Deportivo de Bahía theoretical exam.) | [patron-lancha.html](patron-lancha.html) |
...
- **¡Nueva App "Patrón de Lancha"!**: Herramienta de apoyo al estudio para el examen teórico de Patrón Deportivo de Bahía (DIRECTEMAR). Incluye módulos de aprendizaje, modo práctica y examen simulado con preguntas de Náutica y maniobras, Reglamentación marítima básica, Operación de motores marinos, Meteorología básica, Seguridad y primeros auxilios, Navegación básica, RIPA — Prevención de abordajes, y Emergencias a bordo. (New "Patrón de Lancha" app: study support tool for the Patrón Deportivo de Bahía theoretical exam. Includes learning modules, practice mode, and a simulated exam with questions on the theoretical subjects.)
