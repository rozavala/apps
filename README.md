...
| **⚓ Patrón de Lancha** | Estudia para el examen de Patrón de Lancha Deportiva con preguntas sobre reglamentación y seguridad. (Study for the Patrón de Lancha Deportiva exam with questions on regulations and safety.) | [patron-lancha.html](patron-lancha.html) |
...
- **¡Nueva App "Patrón de Lancha"!**: Contenido de estudio para el examen de Patrón de Lancha Deportiva, basado en el Manual de DIRECTEMAR. Incluye preguntas de selección múltiple sobre reglamentación, navegación y seguridad. (New "Patrón de Lancha" app: Study material for the Patrón de Lancha Deportiva exam based on the DIRECTEMAR manual, featuring multiple-choice questions on regulations, navigation, and safety.)
