...
| **⚓ Patrón de Lancha** | Prepárate para el examen teórico de Patrón de Lancha (Chile). (Prepare for the boat pilot theory exam with practice modes and mock tests.) | [patron-lancha.html](patron-lancha.html) |
...
- **¡Nueva App "Patrón de Lancha"!**: Prepárate para el examen teórico de DIRECTEMAR con simulacros y modos de práctica. (A new app to study for the Chilean boat pilot exam).
