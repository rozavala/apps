...
| **⚓ Patrón de Lancha** | Prepara el examen teórico de Patrón de Lancha Deportiva (Chile): estudia y practica. (Prepare for the theoretical exam of Sports Boat Skipper in Chile: study and practice.) | [patron-lancha.html](patron-lancha.html) |
...
- **¡Nueva App "Patrón de Lancha"!**: Prepara el examen teórico de Patrón de Lancha Deportiva (Chile): estudia y practica en módulos de náutica, reglamentación marítima básica, operación de motores marinos, meteorología básica, seguridad, navegación básica, emergencias y navegación a vela. (New "Patrón de Lancha" app: Prepare for the theoretical exam of Sports Boat Skipper in Chile: study and practice.)
